...
public class BtnRegular extends AppCompatButton {
    ...
    public BtnRegular(Context context) {
        super(context);
    }

    public BtnRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public BtnRegular(Context context, AttributeSet attrs, int defStyle) {
